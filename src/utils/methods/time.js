...
export function latestTimeAgo(epochTime) {
  ...
  for (const timeRepresentation of Object.keys(CONSECUTIVE_NUMERICAL_TIME_CONVERSIONS).reverse()) {
    const convertedTime = epochNumerialConverter(Date.now() - epochTime, timeRepresentation);
